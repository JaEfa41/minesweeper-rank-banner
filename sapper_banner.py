...
# Загружаем шрифт ALGER.TTF из папки со скриптом
try:
    # Пробуем загрузить ALGER.TTF
    font_large = ImageFont.truetype("seguiemj.ttf", 24)
    font_medium = ImageFont.truetype("ALGER.TTF", 40)
    font_small = ImageFont.truetype("ALGER.TTF", 40)
